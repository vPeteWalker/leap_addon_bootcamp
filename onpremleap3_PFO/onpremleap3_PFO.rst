...
In this exercise you will perform an **Planned** failover of your application, a graceful failover which can be used to test and report on DR plans. The key differences from a **Unplanned** failover are...
